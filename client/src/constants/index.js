...
export const HOME_TITLE = 'The Community Showcase';  
export const HOME_DESC = 'Browse through a collection of imaginative and visually stunning images generated by DALL-E AI';

export const CREATE_TITLE = 'Create';
export const CREATE_DESC = 'Create imaginative and visually stunning images through by DALL-E AI and share them with the community';
export const CREATE_SHARE_MSG = 'Once you have created the image you want, you can share it with others in the community';